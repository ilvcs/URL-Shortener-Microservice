...
var dbUrl = "mongodb://shortUrlDb:t123@ds121575.mlab.com:21575/surls"
...
app.get("/", function (request, response) {
  response.send("Type your url to shorten at the end of the url Ex:" + " https://rhinestone-jewel.glitch.me/http://www.yoururl.com");
});
...
app.get("/:url", function (req, res) {
  ...
  if(url.match(spattren)){
    ...
    URLS.findOne({shortUrl:url},function(err,data){
      if(error){
        res.send({"error":"No url in the database"});
      }else{
